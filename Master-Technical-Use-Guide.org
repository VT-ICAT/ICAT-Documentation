...
2. At ICAT, we have bound custom shortcuts for Reaper to help with automating Ambisonics routing:
   - C+(shift)+G - Show all automation lanes of a selected track
   - C+(shift)+H - Hide all automation lanes
