...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.0, 50.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 563.0, 21.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1255.0, 293.5, 150.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1224.0, 38.0, 113.600001692771912, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 454.999997496604919, 354.400005280971527, 113.600001692771912, 20.0 ],
					"text" : "Coordinate Preset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1306.400019466876984, 67.200001001358032, 85.600001275539398, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 461.399997591972351, 401.600005984306335, 85.600001275539398, 33.0 ],
					"text" : "coordinate preset save"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 434.999997198581696, 400.800005972385406, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1204.0, 91.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1204.0, 38.0, 18.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 434.999997198581696, 354.400005280971527, 18.0, 34.0 ],
					"size" : 2,
					"value" : 1
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 509.0, 45.0, 150.0, 33.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 341.0, 40.0, 63.0, 22.0 ],
													"text" : "r to-preset"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 115.0, 184.0, 32.0, 22.0 ],
													"text" : "1 $1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 113.0, 301.0, 133.0, 22.0 ],
...
,
									"patching_rect" : [ 647.0, 116.0, 73.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 518.0, 239.0, 73.0, 22.0 ],
									"text" : "west-centric"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 625.0, 239.0, 75.0, 22.0 ],
									"text" : "north-centric"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 63.0, 109.0, 44.0, 22.0 ],
									"text" : "sel 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 279.0, 197.0, 150.0, 33.0 ],
									"text" : "North is forward, north-centric"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 56.0, 197.0, 150.0, 33.0 ],
									"text" : "West is forward, west-centric"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 239.0, 182.0, 22.0 ],
									"text" : "aed 1 180 10 0.1, aed 2 0 10 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 279.0, 239.0, 189.0, 22.0 ],
									"text" : "aed 1 270 10 0.1, aed 2 90 10 0.1"
								}
...
,
					"patching_rect" : [ 1208.0, 129.0, 94.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 978.0, 139.0, 139.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 711.0, 1.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 840.0, 341.0, 56.831708847485402, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 173.201566364385855, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 840.0, 205.0, 83.60728184748541, 125.410922771228115 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.0, 38.0, 245.0, 148.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 928.0, 21.0, 245.0, 148.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 33.722222222222229, 333.0, 135.0, 131.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.722222222222229, 21.0, 55.0, 22.0 ],
					"text" : "adc~ 1 2",
					"varname" : "the-adc"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 167.923095999999987, 372.0, 211.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 380.0, 48.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 883.423095999999987, 474.638184000000138, 55.0, 49.0 ],
					"text" : "aed 2 90. 10. 0.1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.222222222222229, 139.0, 88.0, 22.0 ],
					"text" : "r sourcecoords"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 711.0, 205.0, 63.0, 22.0 ],
					"text" : "s lscoords"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 607.471496999999999, 492.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 33.722222222222229, 173.0, 120.0, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1, 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
